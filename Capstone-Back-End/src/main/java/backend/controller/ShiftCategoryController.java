...
@RestController
@RequestMapping(value = "/shiftCategory")
public class ShiftCategoryController {
    ...
    @PostMapping(value = "")
    public ResponseEntity<?> create(@RequestBody ShiftCategory shiftCategory) {
        try {
            service.create(shiftCategory);
    ...
    @PutMapping(value = "")
    public ResponseEntity<?> update(@RequestBody ShiftCategory shiftCategory) {
        try {
            service.update(shiftCategory);
