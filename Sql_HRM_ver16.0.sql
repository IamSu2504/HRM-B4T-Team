...
DELETE FROM `hrm_b4t`.`phanloai_baohiem` WHERE (`id` = '3');
UPDATE `hrm_b4t`.`phanloai_baohiem` SET `phan_tram` = '9' WHERE (`id` = '1');
UPDATE `hrm_b4t`.`phanloai_baohiem` SET `id` = '3', `ma_bh` = 'BH3' WHERE (`id` = '4');
ALTER TABLE `hrm_b4t`.`hopdong` 
