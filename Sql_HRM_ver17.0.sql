...
ALTER TABLE `hrm_b4t`.`trinhdovanhoa` 
CHANGE COLUMN `tu_thoi_gian` `tu_thoi_gian` INT NULL DEFAULT NULL ,
CHANGE COLUMN `den_thoi_gian` `den_thoi_gian` INT NULL DEFAULT NULL ;
