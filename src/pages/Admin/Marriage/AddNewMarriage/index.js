...
export default function AddMarriage() {
    ...
    const handleCreate = async () => {
        try{
            ...
            if ( !tinhTrang.trim().length ){
                ...
                const updateRes = await MarriageAPI.addNewMarriage({...marriageDetail})
        ...
        <div className="update-account-page">
            <div className="row">
                <div className="col-12">
                    <div className="title">Thêm Thông Tin Tình Trạng Hôn Nhân</div>
